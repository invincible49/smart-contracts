...
contract CarrotSwap_Stake is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    address public constant tokenAddress = 0x61FA583E1794E03da42e537c881C254a3E562f71;  // Carrot token contract address
    ...
    uint public constant unstakeTime = 1 hours;  // unstaking possible after 1 hours
    ...
    uint private constant stakingAndCarrots = 1e25; //totalsupply generated from zero address
